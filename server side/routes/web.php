...
Route::get('/', function () {
    $deviceToken = "csP8ErItRL-VbfPrJ1JCno:APA91bFHFpnCy6XSloDuMZFhL-0PlPaSOy4nNVHYmoOz-F24IE7ErEFPLPWHIj6Sd5aU5LLcyVgx4YxN0787Ww7x8UbEYo2TD1v6RWgqnMB-xtxJrZ3bHnA6cvs9C6qDsDXUMIFgqY6j";
    $factory = (new Factory)->withServiceAccount(__DIR__ . '\..\fcmtest-73a06-firebase-adminsdk-nafl1-ae84c5f43d.json');

    $messaging = $factory->createMessaging();

    $message = CloudMessage::withTarget('token', $deviceToken)->withNotification(Notification::create('Title is title', 'Body is body2'))
    ->withData(['title' => 'text messsssage']);
